...
function($ionicModal, $rootScope, $q) {
  ...
  var template = '<div class="jr-crop modal">' +
                    ...
                    '<div class="bar bar-footer bar-dark jr-crop-footer">' +
                      '<button class="button button-clear button-icon icon ion-close-round button-assertive" ng-click="cancel()"></button>' +
                      '<div class="title">{{title}}</div>' +
                      '<button class="button button-clear button-icon icon ion-checkmark-round button-balanced" ng-click="crop()"></button>' +
                    '</div>' +
                  '</div>';
