...
@interface LaunchEventController ()<DLDatePickerViewDelegate, UITableViewDataSource, UITableViewDelegate>
...
- (void)builtEventCover
{
    ...
    [chooseButton setBackgroundColor:[UIColor lightGrayColor]];
    [self.superView addSubview:chooseButton];
    ...
    [timeLine mas_makeConstraints:^(MASConstraintMaker *make) {
        make.centerY.mas_equalTo(chooseButton.mas_centerY);
        make.left.mas_equalTo(chooseButton.mas_right).offset(15);
    ...
    [startLabel mas_makeConstraints:^(MASConstraintMaker *make) {
        ...
        make.top.mas_equalTo(chooseButton.mas_top);
    ...
    [overTime mas_makeConstraints:^(MASConstraintMaker *make) {
        ...
        make.bottom.mas_equalTo(chooseButton.mas_bottom);
    }];
...
{
    UIView *remindView = [UIView new];
    [remindView setBackgroundColor:[UIColor whiteColor]];
    
    [self.eventScroll addSubview:remindView];
    ...
    CGRect eventNameRect = [eventStr boundingRectWithSize:CGSizeMake(1000000, 0) options:NSStringDrawingUsesLineFragmentOrigin attributes:@{NSFontAttributeName : [UIFont systemFontOfSize:15]} context:nil];
    [remindView addSubview:remind];
    [remind mas_makeConstraints:^(MASConstraintMaker *make) {
        make.top.mas_equalTo(remindView.mas_top).offset(DLScreenHeight / (667 / 12));
        make.left.mas_equalTo(remindView.mas_left).offset(10);
        make.size.mas_equalTo(CGSizeMake(eventNameRect.size.width, 20));
    }];
    ...
    [remindView addSubview:foldButton];
    
    [foldButton mas_makeConstraints:^(MASConstraintMaker *make) {
        make.top.mas_equalTo(remindView.mas_top);
        make.right.mas_equalTo(remindView.mas_right);
        make.size.mas_equalTo(CGSizeMake(DLMultipleHeight(49.0), DLMultipleHeight(49.0)));
    }];;
    ...
    self.remindTimeTableView = [[UITableView alloc]initWithFrame:CGRectMake(0, 0, DLScreenWidth, 110) style:UITableViewStylePlain];
    ...
    [remindView addSubview:self.remindTimeTableView];
    
}

- (void)foldButtonAction:(UIButton *)sender
{
//    self.remindTimeTableView.frame = CGRectMake(0, 0, DLScreenWidth, DLMultipleHeight(350.0));
}
