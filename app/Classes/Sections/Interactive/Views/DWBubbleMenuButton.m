...
//        label.text = @"活动";
//        button.backgroundColor = [UIColor re]
...
- (void)showButtons {
    ...
    for (int i = 0; i < buttonContainer.count; i++) {
        ...
        switch (self.direction) {
            ...
            case DirectionUp:
                originPosition = CGPointMake(self.frame.size.width/4.0f * 3.0, self.frame.size.height - self.homeButtonView.frame.size.height);
...
- (void)dismissButtons {
    ...
    for (int i = (int)_buttonContainer.count - 1; i >= 0; i--) {
        ...
        switch (self.direction) {
            ...
            case DirectionUp:
                finalPosition = CGPointMake(self.frame.size.width / 4.0 * 3.0, self.frame.size.height - self.homeButtonView.frame.size.height);
                break;
