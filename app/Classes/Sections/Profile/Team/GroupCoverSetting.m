...
//        
    self.headerView.image = imageAssets[0];
...
- (IBAction)OKButtonAction:(id)sender {
    ...
    switch (self.state) {
        case ChangeStateNo:
        {
            UIAlertView *al = [[UIAlertView alloc]initWithTitle:@"失败" message:@"您未做任何修改" delegate: self cancelButtonTitle:@"取消" otherButtonTitles: nil, nil];
            [al show];
        }            break;
