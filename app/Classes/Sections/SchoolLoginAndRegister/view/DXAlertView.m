...
//        self.layer.cornerRadius = 5.0;
        ...
        self.alertTitleLabel.textColor = [UIColor colorWithWhite:.5 alpha:1];
...
//            self.rightBtn.frame = rightBtnFrame;
        ...
        [self.rightBtn setBackgroundImage:[UIImage imageWithColor:[UIColor colorWithRed:255.0/255.0 green:214.0/255.0 blue:0/255.0 alpha:1]] forState:UIControlStateNormal];
        [self.leftBtn setBackgroundImage:[UIImage imageWithColor:[UIColor colorWithRed:237.0/255.0 green:237.0/255.0 blue:237.0/255.0 alpha:1]] forState:UIControlStateNormal];
